...
#define MPR121_SENSOR_AMOUNT_DEFAULT 12
...
public:
  ...
  bool begin(uint8_t i2caddr = MPR121_I2CADDR_DEFAULT, TwoWire *theWire = &Wire,
            ...
            uint8_t sensorAmount = MPR121_SENSOR_AMOUNT_DEFAULT);
  ...
  void setThreshholds(uint8_t touch, uint8_t release, uint8_t sensorAmount)
      __attribute__((deprecated));
  void setThresholds(uint8_t touch, uint8_t release, uint8_t sensorAmount);
